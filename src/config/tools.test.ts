...
describe('TOOL_PROFILES', () => {
  it('contains claude, antigravity, codex, and copilot', () => {
    expect(Object.keys(TOOL_PROFILES)).toEqual(['claude', 'antigravity', 'codex', 'copilot']);
  });
...
describe('getToolNames', () => {
  it('returns array of tool names', () => {
    ...
    expect(names).toEqual(['claude', 'antigravity', 'codex', 'copilot']);
  });
